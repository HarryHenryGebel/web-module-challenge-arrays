 ...
 * should accept:
   ...
   Your function should return a boolean TRUE if the length of the
   array is 31 and FALSE if the length of the array is NOT 31.

   To save you from having to count the items above, you can assume
   that length of originalFlavors is 31. You may also want to test
   your function by creating and passing an array of a different
   length, to make sure it returns FALSE if length is not 31.
 ...
 * array! Your task is to remove an item from the end of the array.
   ...
   Your function should remove a flavor from the end of the array and
 ...
 * last flavor. Your task is to get an index by flavor name, and
 ...
 * track of the actual, original 31 flavors. Write a function called
 ...
 * these values. Rather than hardcoding "chocolate" into your
 * function, pass a string as a parameter, and invoke with the
 ...
 * and even regional flavors. Write a function that will randomly
 * select a total of 31 flavors from originalFlavors, currentFlavors,
 * seasonalFlavors, and regionalFlavors.
   ...
   forExample, getRandomFlavors(originalFlavors, newFlavors,
   seasonalFlavors, regionalFlavors) might return ["Strawberry
   Cheesecake", "Eggnog,"..."Chocolate"].*/
